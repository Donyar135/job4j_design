...
class AnalysisTest {
    ...
    void drop(@TempDir Path tempDir) throws IOException {
        ...
        Analysis.unavailable(source.getAbsolutePath(), target.getAbsolutePath(), List.of("100", "200", "300"));
        StringBuilder result = new StringBuilder();
        try (BufferedReader input = new BufferedReader(new FileReader(target))) {
            input.lines().forEach(result::append);
        }
        assertThat("10:58:01;10:59:0111:01:02;11:02:02").hasToString(result.toString());
    }
